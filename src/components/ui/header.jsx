...
const Header = () => {
    return (
        <div className="md:fixed w-full md:backdrop-blur-sm md:max-w-[2000px] top-0 z-50 md:px-20 py-[29px] md:h-[110px] md:bg-gradient-to-br to-[#17171733] from-[#00000033] flex justify-center md:justify-between   md:border-b-[0.5px] border-[#969696] items-center ">
